...
const Experience1 = ({ experiences, resumeId }) => {
    ...
    <div className="landingcontainer">
      <div className="hero-gallery">
        <div className="work-experience-entry">
          <h3 className="work-experience1">Work Experience</h3>
        </div>
        <button className="add-new-work" onClick={addExperience}>
          <div className="add-new2">Add new</div>
          <div className="fibradd-instance">
  ...
  <defs>
    <clipPath id="clip0_1_188">
      ...
      <div className="landingcontainer-child" />
      {experiences.map((experience, index) => {
        const skillsArray = experience.skills.split(" ");
        return (
          <section key={index} className="backed-by-decades-of-research">
            <div className="a-new-alternative-for-your-pat">
              <div className="ux-designer-google-chennai-parent">
                <div className="ux-designer-google-chennai">
                  {experience.role} @ {experience.company} 
                </div>
                <div className="apr-2022-">
                  {experience.startDate} - {experience.endDate} 
                </div>
              </div>
              <div className="edit-experience" onClick={() => editExperience(experience)}>
                <div className="edit2">Edit</div>
                {/* Edit icon */}
              </div>
            </div>
            <div className="lorem-ipsum-dolor-container1">
              <ul className="lorem-ipsum-dolor-sit-amet-con1">
            ...
            <div className="experience-description">
              {skillsArray.map((skill, i) => (
                <button key={i} className="html-wrapper">
